	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (un == null || pw == null || un.equals("") || pw.equals("")) {
			...
			try {
				...
				// 2.定义连接数据库的地址ַ
				String url = "jdbc:mysql://127.0.0.1:3306/meal?useUnicode=true&character=utf8&useSSL=false&serverTimezone=UTC";
				// 3.建立与数据库的连接  jdbc:mysql://localhost:3306/mydb  jdbc:mysql://127.0.0.1:3306/meal?serverTimezone=UTC
